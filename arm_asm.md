...
という感じです。
ただ一つの状態で入力を連続して読む場合はcaseの中で読んでしまう場合もあります。
その場合は4以下を変えて以下のようにします。
...
別に細部が違ってても構いませんが、こっそり別のstateの処理を別のcaseの中でやる場合がある、とかそういうのはやめた方が良い。
