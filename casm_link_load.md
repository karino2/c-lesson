...
JITしたい、という要望があったので、JITの課題も作る事にしました。
...
または第二回でやってたように、アセンブリで目的の関数を書いてみてバイナリを作ってobjdumpしてみればほぼ答えが得られるので、あとはひたすらその結果を代入していきましょう。

ただ、採点する側の私の気持ちになって、各バイナリのニモニックはコメントで書いてください。
